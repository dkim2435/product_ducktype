  ...
  return (
    <article className="max-w-[700px] mx-auto px-6 py-10 text-text leading-[1.8] text-[15px]">
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">1. Acceptance of Terms</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">2. Description of Service</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">3. User Conduct</h2>
        <p className="mb-3">When using the Service, you agree not to:</p>
        <ul className="pl-5">
          <li className="mb-2">Attempt to disrupt or interfere with the Service's functionality</li>
          <li className="mb-2">Use automated tools or bots to interact with the Service</li>
          <li className="mb-2">Attempt to bypass any security features of the Service</li>
          <li className="mb-2">Use the Service for any unlawful purpose</li>
        </ul>
      </section>

      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">4. Intellectual Property</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">5. Advertisements</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">6. Disclaimer of Warranties</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">7. Limitation of Liability</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">8. Changes to Terms</h2>
        <p>
      ...
      <section className="mb-7">
        <h2 className="text-lg text-main mb-3">9. Contact</h2>
        <p>
