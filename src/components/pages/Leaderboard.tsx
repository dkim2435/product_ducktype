        ...
        <>
          ...
          {tableEntries.length > 0 && (
            <div style={{
              ...
              {/* Pinned user row at bottom when not in podium */}
              {effectiveRank > 3 && effectiveEntry && (
                <>
                  {/* Dots separator */}
                  <div style={{
                    padding: '6px 16px',
                  ...
                  <div style={{
                    ...
                    padding: '10px 16px',
                    fontSize: '13px',
                    backgroundColor: 'rgba(var(--main-color-rgb, 226,183,20), 0.15)',
                    ...
                    {!isMobile && (
                      <span style={{
                        ...
                        <div style={{
                          ...
                          <div style={{
                            width: maxWpm > 0 ? `${(effectiveEntry.wpm / maxWpm) * 100}%` : '0%',
                            height: '100%',
                    ...
                    <span style={{
                      ...
                      {isMobile ? effectiveEntry.wpm : `${effectiveEntry.accuracy}%`}
                    </span>
                  </div>
                </>
              )}
